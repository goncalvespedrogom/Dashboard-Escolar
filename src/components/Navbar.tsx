        ...
        <div className='flex items-center justify-between p-4'>
            ...
            <div className='flex items-center gap-6 justify-end w-full'>
                ...
                <div className='bg-white rounded-full w-7 h-7 flex items-center cursor-pointer relative'>
                    ...
                    <div className='absolute -top-3 -right-3 w-5 h-5 flex items-center justify-center bg-[#195383] text-white rounded-full text-xs'>1</div>
                </div>
                <div className='flex flex-col'>
                    <span className="text-xs leading-3 font-medium">João Silva</span>
