    ...
    <div className="flex-1 p-4 flex flex-col gap-4 xl:flex-row">
          ...
          <div className="bg-white py-6 px-4 rounded-md flex-1 flex gap-4">
            ...
            <div className="w-2/3 flex flex-col justify-between gap-4">
              <div className="flex items-center gap-4">
                <h1 className="text-xl font-semibold">Leonardo Machado</h1>
                {role === "admin" && <FormModal
                  table="teacher"
                  type="update"
                  data={{
                    id: 1,
                    username: "leonardomachado",
                    email: "leonardomachado@gmail.com",
                    password: "password",
                    firstName: "Leonardo",
                    lastName: "Machado",
                    phone: "(28) 99999-9999",
                    address: "Av. Exemplo, Bairro, Cidade, n°10",
                    bloodType: "A+",
              ...
              <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
                ...
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                  ...
                  <span>leonardomachado@gmail.com</span>
                </div>
                <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          <h1 className="text-xl font-semibold">Infos do Professor</h1>
